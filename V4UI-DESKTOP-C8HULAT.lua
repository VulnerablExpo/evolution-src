...
do
	...
	do
		...
		function Sections:Slider(Properties)
			...
			Slide.Position = UDim2.new(1, -130, 0.5, 0)
			Slide.Size = UDim2.new(1, -100, 0, 4)
		...
		function Sections:List(Properties)
			...
			List.Size = UDim2.new(0, Box.AbsoluteSize.X, 0, 150)
			List.Visible = false
			...
			local function createoptions(tbl)
				for _, option in next, tbl do
					...
					if Dropdown.ScrollMax then
						...
						List.Size = UDim2.new(0, Box.AbsoluteSize.X, 0, 20*Count)
					end
...
do
    ...
    --
    Section:Toggle({Name = "Enabled", Flag = "Enabled", Callback = function(v)
        print(v)
    end})
    Section:Slider({Name = "Hit Chance", Min = 1, Def = 100, Max = 100, Suffix = "%", Flag = "hit_chance", Callback = function(v)
        print(v)
    end})
    ...
    Sec2:List({Name = "Multi Combo",Options = {"green fn", "fent", "shit", "fort", "nite"}, Max = 3})
